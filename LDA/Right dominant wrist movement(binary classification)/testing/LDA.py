...
ds1=np.load("Right dominant wrist movement(binary classification)\\dataset\\yes1.npy")
ds2=np.load("Right dominant wrist movement(binary classification)\\dataset\\yes2.npy")
ds3=np.load("Right dominant wrist movement(binary classification)\\dataset\\yes3.npy")
# ds4=np.load("yes4.npy")
ds5=np.load("Right dominant wrist movement(binary classification)\\dataset\\no1.npy")
ds6=np.load("Right dominant wrist movement(binary classification)\\dataset\\no2.npy")
ds7=np.load("Right dominant wrist movement(binary classification)\\dataset\\no3.npy")
